...
function EnergyCharacteristics(Characteristic) {
    ...
    EnergyCharacteristics.TotalConsumption1 = function() {
    ...
    inherits(EnergyCharacteristics.TotalConsumption1, Characteristic);
    ...
    inherits(EnergyCharacteristics.CurrentConsumption1, Characteristic);
