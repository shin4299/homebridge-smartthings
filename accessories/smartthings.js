...
var Accessory, Service, Characteristic, uuid, EnergyCharacteristics, CurrentPowerConsumption;
...
// ------------------------
    ...
    Characteristic.CurrentPowerConsumption = function() {
		Characteristic.call('Consumption', 'E863F10D-079E-48FF-8F27-9C2605A29F52');
		this.setProps({
    ...
    Characteristic.TotalPowerConsumption = function() {
		Characteristic.call('Total Consumption', 'E863F10C-079E-48FF-8F27-9C2605A29F52');
		this.setProps({
    ...
    Characteristic.UVIndex = function() {
		Characteristic.call('UV Index', '05ba0fe0-b848-4226-906d-5b64272e05ce');
		this.setProps({
    ...
    Characteristic.AirPressure = function() {
		Characteristic.call('Air Pressure', 'E863F10F-079E-48FF-8F27-9C2605A29F52');
		this.setProps({
...
*/	    
		...
		thisCharacteristic = this.getaddService(Service.Outlet).addCharacteristic(Characteristic.CurrentPowerConsumption)
    ...
    if ((device.capabilities["Carbon Dioxide Measurement"] !== undefined) && (that.device.attributes.carbonDioxide)) {
        ...
        thisCharacteristic.on('get', function(callback) {
                if (that.device.attributes.carbonDioxide < 1000 )
                    callback(null, Characteristic.CarbonMonoxideDetected.CO2_LEVELS_NORMAL);
                else
                    callback(null, Characteristic.CarbonMonoxideDetected.CO2_LEVELS_ABNORMAL);
            });
 		that.platform.addAttributeUsage("carbonMonoxide", this.deviceid, thisCharacteristic);
